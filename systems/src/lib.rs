...
use bevy::{prelude::*, render::camera::ScalingMode, sprite::collide_aabb};
use components::*;
...
pub fn setup(mut commands: Commands, asset_server: Res<AssetServer>) {
	...
	camera_bundle.projection.scaling_mode = ScalingMode::FixedVertical(900.);
...
pub fn spawn_other_ships(
	...
	if other_ships_count < MIN_SHIP_COUNT {
		...
		commands
			.spawn_bundle(SpriteBundle {
				texture: asset_server.load("textures/enemy_A.png"),
				transform,
				..default()
			})
			.insert(OtherShip);
